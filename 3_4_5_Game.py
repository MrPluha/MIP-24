...
class GameGUI:
    ...
    def create_widgets(self):
        ...
        if self.toggle_beginner == 0:
            self.player_label = ctk.CTkLabel(self.playersname_frame, text="Cilveks        Dators", font=ctk.CTkFont("Arial", size=15))
        else:        
            self.player_label = ctk.CTkLabel(self.playersname_frame, text="Dators        Cilveks", font=ctk.CTkFont("Arial", size=15))
